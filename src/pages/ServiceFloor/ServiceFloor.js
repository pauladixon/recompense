    ...
    return (
      <div className="service-page">
        <div className="page-header">
          ...
          <p className='justify'>This is a place for non-black people to post free and discounted services / offerings / assistance for black and indigenous people in their communities. Please be mindful of others in this space and put your heart forward.</p> 
          <br></br>
